...
export async function GET(request: NextRequest) {
	try {
		...
		console.log('[API] Fetching NFTs for address:', address);

		const response = await fetch(`${serverUrl}/api/contracts/player/${address}/nfts`, {
			cache: 'no-store'
		});
		...
		console.log('[API] NFTs data received:', data);
