...
const QRGenerator: React.FC<QRGeneratorProps> = ({
  ...
  useEffect(() => {
    ...
    const controllerUrl = `${baseUrl}/test-shooter/controller?roomId=${roomId}`;
      ...
      <div className="text-center">
        ...
        <div className="w-48 h-48 mx-auto mb-4 bg-white rounded-lg flex items-center justify-center">
          <div className="text-center">
            ...
            <p className="text-gray-500 text-xs">Комната: {roomId}</p>
          </div>
        </div>
        ...
        <div className="mt-4 text-gray-400 text-sm">
          ...
          <p>для подключения к игре как контроллер</p>
        </div>
      </div>
    </div>
  );
